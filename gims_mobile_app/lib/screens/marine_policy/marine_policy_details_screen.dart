...
class MarinePolicyDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Marine Policy Details', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            ...
            _buildDetailCard([
              ...
              _detailRow('Voyage To', policy.voyageTo ?? 'N/A'),
              _detailRow('Via', policy.via ?? 'N/A'),
  ...
  Widget _buildHeader(ThemeData theme) {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(Icons.directions_boat_rounded, size: 50, color: Colors.indigo),
          const SizedBox(height: 10),
          Text('Marine Policy #${policy.id}', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
