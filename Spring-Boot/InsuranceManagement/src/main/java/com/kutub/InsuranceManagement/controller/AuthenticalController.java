package com.kutub.InsuranceManagement.controller;

import com.kutub.InsuranceManagement.dto.GenericResponse;
import com.kutub.InsuranceManagement.dto.LoginRequest;
import com.kutub.InsuranceManagement.dto.RegisterRequest;
...
public class AuthenticalController {
    ...
    private static final Logger log = LoggerFactory.getLogger(AuthenticalController.class);
